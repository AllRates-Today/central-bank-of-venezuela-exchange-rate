'use strict';
// Central Bank of Venezuela exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcv';
...
/** Latest rate for one pair, e.g. getRate('USD', 'VES', { apiKey }). */
